  ...
  const sections = [
    {
      ...
      content: [
        ...
        "I've since fortified my General Chemistry 2 knowledge over the years by taking the advanced courses related to it, in addition to all the years teaching or tutoring it. But while I was rebuilding that base, I was having to put extra work into those advanced classes. Falling a little behind at the beginning made everything much harder.",
        "My advice here is to never fall behind. The best way to do that is with a tutor that will keep you several steps ahead, not just by preparing you for the class you're taking, but by connecting these foundational concepts to whatever you're learning them for, whether it's chemistry, medicine, engineering, physics, or even philosophy (I'm always surprised how often equilibrium comes up).",
        "Also, I'll help you with equation sheets, show you when and how to use everything on them, and how to know what you need to memorize.",
      ],
