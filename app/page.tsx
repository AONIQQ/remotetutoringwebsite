...
const BookCallButton = ({ children, icon }: { children: React.ReactNode, icon?: string }) => (
  <Link href="/book">
    <button
      className="bg-[#1F1D24] text-white border-2 border-[#52747D] rounded-md text-base font-bold flex items-center justify-center space-x-2 px-6 py-3 transition-transform duration-300 hover:scale-105 shadow-lg"
    >
      {icon && <Image src={icon} alt="Icon" width={20} height={20} className="mr-2" />}
      {children}
    </button>
  </Link>
)
      ...
      <div className="bg-gradient-to-r from-[#303B42] via-[#52747D] to-[#303B42] py-16">
        <main className="px-4 sm:px-6 max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center">
            <BookCallButton icon="/Icon Graphics/Icon_Phone Call.png">
      ...
      <div className="bg-gradient-to-r from-[#303B42] via-[#52747D] to-[#303B42] py-12">
        <section className="px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link href="/services">
              <button className="bg-[#1F1D24] text-white border-2 border-[#52747D] rounded-md text-lg font-bold flex items-center justify-center space-x-2 mx-auto px-10 py-3 transition-transform duration-300 hover:scale-105 shadow-lg">
                <span>Learn more</span>
                <Image src="/Icon Graphics/Icon_Test Tube in Stand.png" alt="Learn More" width={24} height={24} className="ml-2" />
              </button>
            </Link>
          </div>
        </section>
